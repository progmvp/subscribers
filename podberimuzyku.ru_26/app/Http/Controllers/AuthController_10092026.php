    ...
    public function sendCode(Request $request)
    {
        ...
        if (
            ...
            return back()
                ->withInput()
                ->withErrors([
                    'email' => 'Активная подписка не найдена.',
                ]);
        }

        /*
         * ==========================================================
         * 3. Не позволяем запрашивать новый код слишком часто.
         * ==========================================================
         */
        ...
        /*
         * ==========================================================
         * 5. Сохраняем данные OTP в сессии.
         * ==========================================================
         */
        session([
